...
abstract class Exchange
{
     ...
     *      }
     *
     * @todo the updatePrices() function for each exchange should use makeStandardSymbol($exchangeSymbol) to get the
     *     key for each currency pair array note: trading pair symbol could be different but parameters these are the
     *     same across all exchanges It is assigned in the updatePrices() function and retrieved with the getPrices()
     *     function.
     *
     * @var array of arrays
     */
    protected $prices = [];     // API Key
    /**
    ...
    { // this function is overridden until updateBalance() is implemented
